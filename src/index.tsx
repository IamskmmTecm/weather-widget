...
// import { WeatherWidgetProps, WeatherWidget } from "./weather-widget";
...
//   /**
//    *  <weather-widget message="world!"></weather-widget>
//    */
//   return class WeatherWidgetBlock extends BaseBlockClass implements BaseBlock {
//     public constructor() {
//       super();
//     }

//     private get props(): WeatherWidgetProps {
//       const attrs = this.parseAttributes<WeatherWidgetProps>();
//       return {
//         ...attrs,
...
//       ReactDOM.render(<WeatherWidget {...this.props} />, container);
//     }
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  ...
  return class WeatherWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<WeatherWidget {...this.props} _widgetApi={_widgetApi} />, container);
    }
